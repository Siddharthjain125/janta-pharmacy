    ...
    <FooterWrapper>
      ...
      <FooterTextWrapper>
        <Box sx={{ width: "100%"}}>
          ...
          <Button onClick={whatsappSupport} variant="contained" className="footer-contactUs-btn"><WhatsAppIcon className="footer-whatsapp-icon"/>CONNECT ON WHATSAPP</Button>
        </Box>
      </FooterTextWrapper>
    </FooterWrapper>
  );
